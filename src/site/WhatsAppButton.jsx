...
export function WhatsAppButton() {
  ...
  return (
    // Geometry lives in CSS (.wa-fab) so it can shrink and tuck into the safe
    // area on phones, where a 58px disc 26px off the corner was landing on top
    // of card text and the hero artwork.
    <div className="wa-fab">
      <div className="wa-fab-inner">
        ...
        >
          <svg className="wa-fab-glyph" width="28" height="28" viewBox="0 0 24 24" fill="#fff" aria-hidden="true" focusable="false">
